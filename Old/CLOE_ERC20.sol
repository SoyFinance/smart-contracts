...
contract ERC20Token is Context, IERC20, Ownable {
  ...
  uint256 constant public MAX_SUPPLY = 125000000 ether;  //Max supply 125,000,000 tokens
  ...
  constructor() public {
    _name = "Callisto Enterprise";
    _symbol = "CLOE";
    _decimals = 18;
    _totalSupply = 0;
    _mint(0x4667d0c30E6f58ef935ddAb560d41E030E4d2AeB, 1000000 ether); // mint 1.000.000 for investors
  }

  // the Gateway has right to mint tokens.
  ...
  */
  ...
  function _mint(address account, uint256 amount) internal {
    ...
    require (_totalSupply <= MAX_SUPPLY, "Can't mint more then MAX_SUPPLY");
